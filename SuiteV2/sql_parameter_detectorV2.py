...
def format_results_as_text(results):
    ...
    """
    text = []
    text.append("SQL/ORM INJECTION PARAMETER DETECTION RESULTS")
    text.append("=" * 50)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="SQL/ORM Injection Parameter Detector Module")
    ...
    if args.xml_file:
        ...
        # Test URL with SQL injection-prone parameters
        test_url = "https://example.com/products?id=123&category=electronics&order_by=price"
        ...
        test_request = {
            ...
            "body": "search=test&filter=active&sort=name"
        }
