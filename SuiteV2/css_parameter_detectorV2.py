...
def format_results_as_text(results):
    ...
    """
    text = []
    text.append("CSS INJECTION PARAMETER DETECTION RESULTS")
    text.append("=" * 50)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="CSS Injection Parameter Detector Module")
    ...
    if args.xml_file:
        ...
        # Test URL with CSS parameters
        test_url = "https://example.com/page?style=custom&theme=dark&color=%23ff0000"
